...
<head>
    <meta charset="UTF-8">
    <title>Data Pendaftar Class Meeting</title>
    <style>
        body {
...
<body>
        ...
        <a href="<?php echo site_url('classmeeting'); ?>" class="btn-tambah">+ Tambah Pendaftaran Baru</a>
        ...
        <table>
            ...
            <tbody>
                ...
                ?>
                    ...
                    ?>
                    <tr>
                        <td colspan="6" class="no-data">Belum ada data pendaftaran.</td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
